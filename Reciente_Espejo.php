<?php
        ...
        // Hacerme una copia del array en cadena para hacer comparaciones..
				$strCadena = implode($a);
				$array_max = array();
				// Si la cadena no está vacía imprimirla...
				if( count($a)!=0 )
         ...
         // En el caso de haber sólo un número.
			   ...
			   }else if(count($a)==2) // Espejo de 2 elementos
				 {
					   if($a[0]==$a[1])
						 {
							 	$r = array();
								$r[0]= $a[0];
								return $r; // No se halla espejo.
			   ...
			   {
					 	 // Devuelvo el array entero tal cual.
						 return $a;
